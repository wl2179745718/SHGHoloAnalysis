...
uout2 = exp(1i*2*pi*fxin*X)*exp(1i*2*pi*(z(end)-z(1)+dr(3))*cos(thetain)/lambda);
...
subplot(3,4,6)
imagesc(x,y,angle(U_MLB2-uout2))
axis square
colorbar
title('\angle U_{MLB2}')
xlim(figure_window)
