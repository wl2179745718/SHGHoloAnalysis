function [] = Diagnose_with_change_dz_for_the_first_layer(X, Y, z_positive, FX, FY, fx, fy, dr, Pdz, k0, lambda, dz1)
...
set(gcf, 'Position', get(0, 'Screensize'));
subplot(2,1,2)
[A,map] = imread("Diagnose with changing dz for the first layer.png");
imshow(A,map)
