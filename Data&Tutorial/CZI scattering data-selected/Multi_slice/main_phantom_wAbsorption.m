...
figure(3); 
subplot(2,2,1);
imagesc(real(obj(:,:,end/2))); axis equal; axis tight; caxis([0,0.07]); colorbar;
subplot(2,2,2);
imagesc(imag(obj(:,:,end/2))); axis equal; axis tight; caxis([0,0.03]); colorbar;
subplot(2,2,3);
imagesc(acqs(:,:,1)); axis equal; axis tight; colormap gray; caxis([0,1.4]); colorbar;
