...
% The sphere
shape = 'TwoSphere';
n1=1.002;%n_array(ii);%1.2;
n2=1.002;
rad1 = 0.5*um;
rad2 = 0.5*um;
R = 2*um;
theta = 45/180*pi;
Make2Sphere(rad1, n1, rad2, n2, n_imm, theta, R, Box, X, Y, z,N,dr, k0);
...
Gdz  = GOlivier(X, Y, dr(1), dr(2),   dr(3), k0);%G_kx_ky(FX,FY,n_imm,lambda,  dr(3),dGk,Eps)./dr(1)./dr(2);
