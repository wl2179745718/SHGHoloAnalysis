...
MLB_err(ii) = norm(U_MLB-uout - U_MOM,2)/norm(uout,2);
MLB2_err(ii) = norm(U_MLB2-uout - U_MOM,2)/norm(uout,2);
MLR_err(ii) = norm(U_MLR-uout - U_MOM,2)/norm(uout,2);
MSR_err(ii) = norm(U_MSR-uout - U_MOM,2)/norm(uout,2);
